...
Уод с расширением .c находится здесь https://github.com/HowToCodeWithPaws/Assembler/blob/master/task4/Vector.c, компилируется командой gcc Vector.c -fopenmp -o vec.exe<br>
